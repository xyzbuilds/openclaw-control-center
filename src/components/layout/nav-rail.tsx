...
const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'model-grid', label: 'Models', icon: <ModelGridIcon />, priority: false },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'git-activity', label: 'Git Log', icon: <GitActivityIcon />, priority: false },
    ],
  },
  {
    id: 'admin',
